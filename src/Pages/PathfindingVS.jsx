...
const MEDIUM = 20;
const SLOW = 50;
var animateTime = MEDIUM; // default
// old value: 8,35,80
...
function App() {
  ...
  const animationTimeHandle = (type) => {
    ...
    else if (type === 2) animateTime = MEDIUM;
  ...
  <h3 className="text-xl text-slate-800 text-center mb-3">Path Finding Algorithms</h3>
  <div className="p-4">
    <h4 className="text-lg text-slate-700">1. Breadth-First Search (BFS)</h4>
    <p className="text-slate-600">
      BFS is an algorithm for traversing or searching tree or graph data structures. It starts at the root (or an arbitrary node) and explores the neighbor nodes at the present depth prior to moving on to nodes at the next depth level. This approach ensures that the shortest path in an unweighted graph is found.
    </p>
    
    <h4 className="text-lg text-slate-700">2. Depth-First Search (DFS)</h4>
    <p className="text-slate-600">
      DFS is an algorithm for traversing or searching tree or graph data structures. It starts at the root and explores as far as possible along each branch before backtracking. It uses a stack to remember which vertex to visit next, making it efficient for searching deep paths in the graph.
    </p>

    <h4 className="text-lg text-slate-700">3. Dijkstra's Algorithm</h4>
    <p className="text-slate-600">
      Dijkstra's algorithm is a graph search algorithm that finds the shortest path between nodes in a graph. It works by assigning a tentative distance value to every node and iteratively updating these values based on the distances of the neighboring nodes. It is particularly useful in weighted graphs.
    </p>

    <h4 className="text-lg text-slate-700">4. A* Search Algorithm</h4>
    <p className="text-slate-600">
      The A* algorithm is an informed search algorithm that finds the shortest path from a start node to a goal node. It uses heuristics to estimate the cost of the cheapest path from the current node to the goal, making it more efficient than Dijkstra's algorithm in many scenarios. A* combines features of BFS and Dijkstra's algorithm.
    </p>
  </div>
</Modal>
      ...
      <div id="Container-blur" className="active">
        <Navbar msg="Path Visualiser"></Navbar>
            ...
            <div>
              <div className="flex justify-end my-[12px] gap-3">
                ...
                >
                  ...
                  <option value="1">Random Basic </option>
                  <option value="2">Randomized Dfs</option>
                  <option value="3">Recursive Aivision</option>
